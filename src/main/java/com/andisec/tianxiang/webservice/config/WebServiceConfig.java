package com.andisec.tianxiang.webservice.config;
...
public class WebServiceConfig {
    ...
    @Autowired
    private TianxiangService tianxiangService;
    ...
    public Endpoint endpoint() {
        EndpointImpl endpoint = new EndpointImpl(springBus(), tianxiangService);
